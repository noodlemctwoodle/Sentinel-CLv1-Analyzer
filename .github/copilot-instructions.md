# Sentinel CLv1 Analyzer — Copilot Instructions
...
- `data/solution-mapping.json` is the static lookup file
- Refreshed weekly by `.github/workflows/update-solution-mapping.yml`
- Source: [Azure-Sentinel Solutions Analyzer](https://github.com/Azure/Azure-Sentinel/tree/master/Tools/Solutions%20Analyzer)
- `data/update-solution-mapping.mjs` fetches upstream CSVs and regenerates the JSON
